...
export const advertisements = pgTable("advertisements", {
  ...
  titleTl: text("title_tl"),
  titleZh: text("title_zh"),
  descriptionTl: text("description_tl"),
  descriptionZh: text("description_zh"),
  targetAudienceTl: text("target_audience_tl"),
  targetAudienceZh: text("target_audience_zh"),
...
export const insertAdvertisementSchema = createInsertSchema(advertisements).pick({
  ...
  descriptionTl: true,
  descriptionZh: true,
  targetAudienceTl: true,
  targetAudienceZh: true,
  startDate: true,
  endDate: true,
});
